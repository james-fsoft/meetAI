...
const T: Record<Lang, {
  title: string; sub: string; newM: string; account: string; today: string;
  ...
  en: {
    ...
    newM: "+ New meeting", account: "Account", today: "Today", month: "Month", week: "Week", list: "List",
  ...
  vi: {
    ...
    newM: "+ Cuộc họp mới", account: "Tài khoản", today: "Hôm nay", month: "Tháng", week: "Tuần", list: "Danh sách",
  ...
  ko: {
    ...
    newM: "+ 새 회의", account: "계정", today: "오늘", month: "월", week: "주", list: "목록",
